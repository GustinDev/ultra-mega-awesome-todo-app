...
const TodoItem: React.FC<TodoItemProps> = ({ todo, onDelete }) => {
  ...
  return (
    <div className="card w-80 h-80 border-2 border-customBlue4 dark:border-gray-100 p-5 bg-white rounded-lg dark:bg-gray-500 ">
      {editing ? (
        // Edit Form
        <form
        ...
        <div className="flex flex-col justify-between h-full w-full">
          ...
          <div className="w-full gap-1 flex justify-between ">
            <button
              className="bg-red-200 border-2 border-black w-2/3 rounded-lg hover:bg-gray-200 dark:bg-red-400"
              onClick={() => onDelete(todo.id)}
            >
              Borrar
            </button>
            <button
              className="bg-blue-200 border-2 border-black w-2/3 rounded-lg hover:bg-gray-200 dark:bg-blue-500"
